...
namespace InstitutoChak.Controllers
{
    public class CategoriasController : Controller
    {
        private readonly InstitutoChakContext _context;

        public CategoriasController(InstitutoChakContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string sortOrder)
        {
            ...
            ViewData["DescripcionSortParm"] = sortOrder == "descripcion-asc" ? "descripcion_desc" : "descripcion_asc";
